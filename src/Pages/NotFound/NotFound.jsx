...
import './NotFound.css'; // Подключаем стили для страницы 404

const NotFound = () => {
    return (
        <section className="container">
            <main className="content-no-found">
                <div>
                    <svg
                        className="paper"
                        viewBox="0 0 300 300"
                    ...
                    >
                        ...
                        >
                            {/* Здесь можно оставить все SVG элементы как есть */}
                ...
                <div>
                    ...
                    <Link className="btn-link" to="/">Вернуться на главную</Link>
                </div>
            </main>
        </section>
    );
